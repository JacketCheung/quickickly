...
from .ctaBase import *
from ctaTempleteExtension import MyTemplate,MyBarGenerator,MyArray

########################################################################
class CtaTemplate(MyTemplate):
    """CTA策略模板"""
...
########################################################################
class BarGenerator(MyBarGenerator):
    """
    K线合成器，支持：
    1. 基于Tick合成1分钟K线
